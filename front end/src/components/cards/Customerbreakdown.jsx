...
const CustomerBreakdown = () => {
  ...
  const pieData = [
    { value: 81, title: "Repeat Customer", colors: ["#FF5A5F", "#ffe6e6"] },
    { value: 22, title: "Promo Redeemed", colors: ["#FFC300", "#fff0b3"] },
    { value: 48, title: "Conversion Rate", colors: ["#D55B61", "#f37c6149"] },
  ];
