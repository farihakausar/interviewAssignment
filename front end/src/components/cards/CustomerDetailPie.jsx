...
const CustomerDetailPie = () => {
  ...
  const pieData = [
    { value: 37, title: "Vodka Redbull", colors: ["#D55B61", "#f37c6149"] },
    { value: 29, title: "Old Fashioned", colors: ["#FFC300", "#fff0b3"] },
    { value: 25, title: "Lager", colors: ["#FF5A5F", "#ffe6e6"] },
  ];
...
export default CustomerDetailPie;
